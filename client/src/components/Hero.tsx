...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/30 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10 py-20 pt-32">
        <div className="max-w-5xl mx-auto">
          ...
          <h2
            className="text-4xl md:text-5xl text-foreground font-bold mb-8 animate-fade-in max-w-5xl mx-auto leading-tight"
            style={{ animationDelay: "0.4s" }}
          >
            Engineering Tomorrow's 
            <span className="gradient-text"> Digital Universe</span>
            <br />
            <span className="text-2xl md:text-3xl font-medium text-muted-foreground mt-4 block">
              Where Innovation Meets Execution
            </span>
          </h2>

          <p
            className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto mb-12 leading-relaxed animate-fade-in font-light"
            style={{ animationDelay: "0.6s" }}
          >
            <span className="font-semibold text-portfolio-blue">5+ years</span> of full-stack development expertise • 
            From blockchain integrations to AI-powered applications • 
            <span className="gradient-text font-semibold">Building reliable, modern solutions</span>
          </p>
